...
const Header: React.FC<HeaderProps> = ({ language, setLanguage, theme, setTheme, content }) => {
    ...
    return (
        <header className="fixed top-4 left-4 right-20 md:left-1/2 md:-translate-x-1/2 md:w-[95%] md:max-w-sm md:right-auto z-40">
            <div className="w-full px-3 sm:px-4 py-2 flex justify-between items-center rounded-full border border-gray-200 dark:border-gray-700 bg-white/50 dark:bg-gray-900/50 backdrop-blur-lg shadow-sm">
                <Logo theme={theme} />
