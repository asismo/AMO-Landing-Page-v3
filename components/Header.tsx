...
const Header: React.FC<HeaderProps> = ({ language, setLanguage, theme, setTheme, content }) => {
    ...
    return (
        <header className="fixed top-4 left-1/2 -translate-x-1/2 w-[95%] max-w-sm z-40">
            <div className="container mx-auto px-4 py-2 flex justify-between items-center rounded-full border border-gray-200 dark:border-gray-700 bg-white/50 dark:bg-gray-900/50 backdrop-blur-lg shadow-sm">
                <Logo theme={theme} />
